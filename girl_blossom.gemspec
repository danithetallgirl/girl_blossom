...
require "girl_blossom/version"

Gem::Specification.new do |spec|
  spec.name          = "girl_blossom"
  spec.version       = GirlBlossom::VERSION
  spec.authors       = ["'Dani Bassett'"]
  spec.email         = ["'dani@danithetallgirl.com'"]

  spec.summary       = %q{this is here because it needs to be.}
  spec.description   = %q{this is here because it needs to be.}
